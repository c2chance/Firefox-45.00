//tealium universal tag - utag.642 ut4.0.201505121652, Copyright 2015 Tealium.com Inc. All Rights Reserved.
var _gaq = _gaq || [];
try {
    (function (id, loader, u) {
        ...
        u.max_custom = 10;
        u.clearVar = function () {
            for (var i = 1; i <= u.max_custom; i++) {
                _gaq.push([u.prefix + '_deleteCustomVar', i])
            }
        };
        u.domain = "" || utag.loader.lh();
        u.prefix = "metrics";
        u.prefix = ((u.prefix) ? u.prefix + '.' : '');
        u.ga1 = "UA-60272843-1";
        u.setallowlinker = true;
        ...
        u.anonymizeIp = "false";
        if (u.anonymizeIp === "true") {
            _gaq.push(['_gat._anonymizeIp'])
        };
        _gaq.push([u.prefix + '_setDomainName', u.domain]);
        if (u.setallowlinker || u.domain == 'none') {
            _gaq.push([u.prefix + '_setAllowLinker', true])
        };
        u.map = {};
        u.extend = [];
        u.send = function (a, b, c, d, e, f, g) {
            if (u.ev[a] || typeof u.ev.all != "undefined") {
                ...
                for (c in utag.loader.GV(b)) {
                    if (typeof u.map[c] != "undefined") {
                        ...
                        for (e = 0; e < d.length; e++) {
                            ...
                            } else if (d[e] == "ga_accountOverride") {
                                _gaq.push([u.prefix + '_setAccount', b[c]])
                            } else if (d[e] == "ga_eventCategory") {
                                b.ga_eventCat = b[c]
                            } else if (d[e] == "ga_campaignCookieTimeout") {
                                _gaq.push([u.prefix + '_setCampaignCookieTimeout', b[c]]);
                            } else if (d[e].indexOf("ga_pageGroup") == 0) {
                                _gaq.push([u.prefix + '_setPageGroup', d[e].substr(d[e].length - 1), b[c]]);
                            } else if (d[e].indexOf("ga_") == 0) {
                                b[d[e]] = b[c]
                            } else {
                ...
                if (b.ga_socialNetwork && b.ga_socialAction) {
                    _gaq.push([u.prefix + "_trackSocial", b.ga_socialNetwork, b.ga_socialAction, b.ga_socialTarget, b.ga_socialPagePath]);
                }
                if (typeof b.ga_eventCat != "undefined") {
                    u.addEvent({
                        eventCategory: b.ga_eventCat,
                        eventAction: b.ga_eventAction,
                        eventLabel: b.ga_eventLabel || null,
                        eventValue: (typeof b.ga_eventValue != "undefined" ? parseInt(b.ga_eventValue) : null)
                    });
                } else if (u.a == "link" && typeof b.event_name != "undefined") {
                    u.addEvent({
                        eventCategory: b.event_name,
                        eventAction: b.link_type,
                ...
                if (b._corder) {
                    ...
                    if (b._ccurrency) {
                        _gaq.push(["_set", "currencyCode", b._ccurrency]);
                    }
