//tealium universal tag - utag.220 ut4.0.201505121652, Copyright 2015 Tealium.com Inc. All Rights Reserved.
try {
    (function (id, loader, u) {
        ...
        u.mt_adid = "110193";
        u.mt_id = "221194";
        u.base_url = "//pixel.mathtag.com/event/js?";
        u.map = {
            "mt_lim": "mt_lim"
        };
        u.extend = [];
        u.send = function (a, b, c, d, e, f, g) {
            if (u.ev[a] || typeof u.ev.all != "undefined") {
                ...
                c.push("mt_id=" + g.mt_id, "mt_adid=" + g.mt_adid, "v1=" + g.v1, "v2=" + g.v2, "v3=" + g.v3);
                c.push("s1=" + g.s1, "s2=" + g.s2, "s3=" + g.s3, "mt_lim=10");
