...
("undefined" != typeof window ? window : this, function (a, b) {
        ...
        if (m.acceptData(a)) {
            ...
            if (g[h]) {
                if (b && (d = c ? g[h] : g[h].data)) {
                    for (m.isArray(b) ? b = b.concat(m.map(b, m.camelCase)) : (b in d) ? b = [b] : (b = m.camelCase(b),
                    b = (b in d) ? [b] : b.split(" ")),
                    e = b.length; e--;)
                        delete d[b[e]];
    ...
    , s, B, C, E, F, H, K, L, M, N, Cb, Db, lc, sc, tc, uc, _c, ad, bd, cd, ed, fd;
    m.fn = m.prototype = {
        jquery: l,
        constructor: m,
        selector: "",
    ...
    s = function (a) {
        ...
        i = fb.select = function (a, b, e, f) {
            ...
            1 === o.length) {
                ...
                for (i = X.needsContext.test(a) ? 0 : j.length; i--;) {
                    if (k = j[i],
                    d.relative[l = k.type])
                        break;
        ...
        add: function (a, b, c, d, e) {
            ...
            if (r) {
                ...
                (k = r.handle) || (k = r.handle = function (a) {
                    if (typeof m !== K && (!a || m.event.triggered !== a.type))
                        return m.event.dispatch.apply(k.elem, arguments)
                }
                ,
                k.elem = a),
                b = (b || "").match(E) || [""],
    ...
    m.fn.extend({
        ...
        triggerHandler: function (a, b) {
            var c = this[0];
            if (c)
                return m.event.trigger(a, b, c, !0)
        }
    });
    ...
    m.each(["height", "width"], function (a, b) {
        m.cssHooks[b] = {
            get: function (a, c, d) {
                if (c)
                    return Ob.test(m.css(a, "display")) && 0 === a.offsetWidth ? m.swap(a, Rb, function () {
                        return Yb(a, b, d)
                    }) : Yb(a, b, d)
            },
            set: function (a, c, d) {
    ...
    return a.ActiveXObject && m(a).on("unload", function () {
        for (var a in Xc)
            Xc[a](void 0, !0)
    }),
    ...
    m.ajaxPrefilter("json jsonp", function (b, c, d) {
        ...
        if (h || "jsonp" === b.dataTypes[0])
            return (e = b.jsonpCallback = m.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback,
