(function(a, b) {
    function d(b, d) {
        var e = b.nodeName.toLowerCase(), f, g, h;
        return "area" === e ? (f = b.parentNode,
        g = f.name,
        !b.href || !g || f.nodeName.toLowerCase() !== "map") ? !1 : (h = a("img[usemap=#" + g + "]")[0],
        !!h && c(h)) : (/input|select|textarea|button|object/.test(e) ? !b.disabled : "a" == e ? b.href || d : d) && c(b)
    }
    function c(b) {
    ...
    a.fn.extend({
        ...
        zIndex: function(c) {
            ...
            if (this.length)
                for (var d = a(this[0]), e, f; d.length && d[0] !== document; ) {
                    if (e = d.css("position"),
                    (e === "absolute" || e === "relative" || e === "fixed") && (f = parseInt(d.css("zIndex"), 10),
                    !isNaN(f) && f !== 0))
                        return f;
                    d = d.parent()
                }
    ...
    a.widget("ui.mouse", {
        ...
        _mouseDown: function(b) {
            if (!c) {
                ...
                return !e || f || !this._mouseCapture(b) ? !0 : (this.mouseDelayMet = !this.options.delay,
        ...
        _mouseMove: function(b) {
            return a.browser.msie && !(document.documentMode >= 9) && !b.button ? this._mouseUp(b) : this._mouseStarted ? (this._mouseDrag(b),
...
function(a) {
    ...
    function() {
        var b = document.getElementsByTagName("body")[0], c = document.createElement("div"), d, e, g, h, i, j;
...
function(a) {
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _mouseCapture: function(b) {
            ...
            !this.handle) ? !1 : (c.iframeFix && a(c.iframeFix === !0 ? "iframe" : c.iframeFix).each(function() {
        ...
        _mouseStop: function(b) {
            var c = !1, d;
            return (a.ui.ddmanager && !this.options.dropBehaviour && (c = a.ui.ddmanager.drop(this, b)),
            this.dropped && (c = this.dropped,
            this.dropped = !1),
            (!this.element[0] || !this.element[0].parentNode) && this.options.helper == "original") ? !1 : (this.options.revert == "invalid" && !c || this.options.revert == "valid" && c || this.options.revert === !0 || a.isFunction(this.options.revert) && this.options.revert.call(this.element, c) ? (d = this,
        ...
        _getParentOffset: function() {
            ...
            return this.cssPosition == "absolute" && this.scrollParent[0] != document && a.ui.contains(this.scrollParent[0], this.offsetParent[0]) && (b.left += this.scrollParent.scrollLeft(),
            b.top += this.scrollParent.scrollTop()),
            (this.offsetParent[0] == document.body || this.offsetParent[0].tagName && this.offsetParent[0].tagName.toLowerCase() == "html" && a.browser.msie) && (b = {
                top: 0,
                left: 0
            }),
            {
        ...
        _generatePosition: function(b) {
            var c = this.options, d = this.cssPosition == "absolute" && (this.scrollParent[0] == document || !a.ui.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, e = /(html|body)/i.test(d[0].tagName), f = b.pageX, g = b.pageY, h, i, j, k;
            return this.originalPosition && (this.containment && (this.relative_container ? (i = this.relative_container.offset(),
            h = [this.containment[0] + i.left, this.containment[1] + i.top, this.containment[2] + i.left, this.containment[3] + i.top]) : h = this.containment,
            ...
            c.grid && (j = c.grid[1] ? this.originalPageY + Math.round((g - this.originalPageY) / c.grid[1]) * c.grid[1] : this.originalPageY,
            g = h ? j - this.offset.click.top < h[1] || j - this.offset.click.top > h[3] ? j - this.offset.click.top < h[1] ? j + c.grid[1] : j - c.grid[1] : j : j,
            k = c.grid[0] ? this.originalPageX + Math.round((f - this.originalPageX) / c.grid[0]) * c.grid[0] : this.originalPageX,
    ...
    a.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(b) {
            var d = a(this).data("draggable")
              , e = d.options
              , f = !1;
            d.scrollParent[0] != document && d.scrollParent[0].tagName != "HTML" ? (e.axis && e.axis == "x" || (d.overflowOffset.top + d.scrollParent[0].offsetHeight - b.pageY < e.scrollSensitivity ? d.scrollParent[0].scrollTop = f = d.scrollParent[0].scrollTop + e.scrollSpeed : b.pageY - d.overflowOffset.top < e.scrollSensitivity && (d.scrollParent[0].scrollTop = f = d.scrollParent[0].scrollTop - e.scrollSpeed)),
            e.axis && e.axis == "y" || (d.overflowOffset.left + d.scrollParent[0].offsetWidth - b.pageX < e.scrollSensitivity ? d.scrollParent[0].scrollLeft = f = d.scrollParent[0].scrollLeft + e.scrollSpeed : b.pageX - d.overflowOffset.left < e.scrollSensitivity && (d.scrollParent[0].scrollLeft = f = d.scrollParent[0].scrollLeft - e.scrollSpeed))) : (e.axis && e.axis == "x" || (b.pageY - a(document).scrollTop() < e.scrollSensitivity ? f = a(document).scrollTop(a(document).scrollTop() - e.scrollSpeed) : a(window).height() - (b.pageY - a(document).scrollTop()) < e.scrollSensitivity && (f = a(document).scrollTop(a(document).scrollTop() + e.scrollSpeed))),
            e.axis && e.axis == "y" || (b.pageX - a(document).scrollLeft() < e.scrollSensitivity ? f = a(document).scrollLeft(a(document).scrollLeft() - e.scrollSpeed) : a(window).width() - (b.pageX - a(document).scrollLeft()) < e.scrollSensitivity && (f = a(document).scrollLeft(a(document).scrollLeft() + e.scrollSpeed))));
    ...
    a.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(b, c) {
            for (var t, d = a(this).data("draggable"), e = d.options, f = e.snapTolerance, g = c.offset.left, h = g + d.helperProportions.width, i = c.offset.top, j = i + d.helperProportions.height, k = d.snapElements.length - 1; k >= 0; k--) {
    ...
    a.ui.plugin.add("draggable", "stack", {
        start: function() {
            ...
            !e.length || (f = parseInt(e[0].style.zIndex) || 0,
            a(e).each(function(a) {
...
function(a) {
    a.widget("ui.droppable", {
        ...
        _drop: function(b, c) {
            var d = c || a.ui.ddmanager.current, e;
            return !d || (d.currentItem || d.element)[0] == this.element[0] ? !1 : (e = !1,
    ...
    a.ui.ddmanager = {
        ...
        prepareOffsets: function(b, c) {
            var d = a.ui.ddmanager.droppables[b.options.scope] || [], e = c ? c.type : null , f = (b.currentItem || b.element).find(":data(droppable)").andSelf(), g, h;
            droppablesLoop: for (g = 0; g < d.length; g++)
                if (!d[g].options.disabled && (!b || d[g].accept.call(d[g].element[0], b.currentItem || b.element))) {
                    ...
                    d[g].visible) && (e == "mousedown" && d[g]._activate.call(d[g], c),
        ...
        drag: function(b, c) {
            ...
            a.each(a.ui.ddmanager.droppables[b.options.scope] || [], function() {
                ...
                if (!(this.options.disabled || this.greedyChild || !this.visible)) {
                    if (d = a.ui.intersect(b, this, this.options.tolerance),
                    e = !d && this.isover == 1 ? "isout" : d && this.isover == 0 ? "isover" : null ,
                    !e)
                        return;
                    this.options.greedy && (g = this.element.parents(":data(droppable):eq(0)"),
...
function(a) {
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        destroy: function() {
            ...
            ,
            this.elementIsWrapper && (b(this.element),
            c = this.element,
        ...
        _mouseStart: function(b) {
            var d = this.options, e = this.element.position(), f = this.element, g, h, i;
            ...
            i = a(".ui-resizable-" + this.axis).css("cursor"),
        ...
        _mouseDrag: function(b) {
            ...
            var l = k.apply(this, [b, i, j])
              ...
              , n = this.sizeDiff;
            return this._updateVirtualBoundaries(b.shiftKey),
            (this._aspectRatio || b.shiftKey) && (l = this._updateRatio(l, b)),
        ...
        _updateVirtualBoundaries: function(a) {
            ...
            (this._aspectRatio || a) && (c = h.minHeight * this.aspectRatio,
        ...
        _respectSize: function(a, b) {
            var c = this.helper, e = this._vBoundaries, f = this._aspectRatio || b.shiftKey, g = this.axis, h = d(a.width) && e.maxWidth && e.maxWidth < a.width, i = d(a.height) && e.maxHeight && e.maxHeight < a.height, j = d(a.width) && e.minWidth && e.minWidth > a.width, k = d(a.height) && e.minHeight && e.minHeight > a.height, p;
            ...
            var l = this.originalPosition.left + this.originalSize.width
              ...
              , n = /sw|nw|w/.test(g)
              , o = /nw|ne|n/.test(g);
            return j && n && (a.left = l - e.minWidth),
        ...
        _proportionallyResize: function() {
            var b = this.options, c, d, e, f, g;
            if (!!this._proportionallyResizeElements.length)
                for (c = this.helper || this.element,
                d = 0; d < this._proportionallyResizeElements.length; d++)
                    (e = this._proportionallyResizeElements[d],
                    this.borderDif || (f = [e.css("borderTopWidth"), e.css("borderRightWidth"), e.css("borderBottomWidth"), e.css("borderLeftWidth")],
    ...
    a.ui.plugin.add("resizable", "containment", {
        start: function() {
            var e = a(this).data("resizable"), f = e.options, g = e.element, h = f.containment, i = h instanceof a ? h.get(0) : /parent/.test(h) ? g.parent().get(0) : h, j, k;
            if (!!i)
    ...
    a.ui.plugin.add("resizable", "grid", {
        resize: function(b) {
            var d = a(this).data("resizable"), e = d.options, f = d.size, g = d.originalSize, h = d.originalPosition, i = d.axis, j = e._aspectRatio || b.shiftKey, k, l;
            e.grid = typeof e.grid == "number" ? [e.grid, e.grid] : e.grid;
            k = Math.round((f.width - g.width) / (e.grid[0] || 1)) * (e.grid[0] || 1);
...
function(a) {
    a.widget("ui.selectable", a.ui.mouse, {
        ...
        _mouseStart: function(b) {
            ...
            this.options.disabled || (d = this.options,
            ...
            a(b.target).parents().andSelf().each(function() {
                var d = a.data(this, "selectable-item"), e;
                if (d)
                    return e = !b.metaKey && !b.ctrlKey || !d.$element.hasClass("ui-selected"),
        ...
        _mouseDrag: function(b) {
            ...
            !this.options.disabled) {
                ...
                this.selectees.each(function() {
                    var i = a.data(this, "selectable-item"), j;
                    !i || i.element == c.element[0] || (j = !1,
...
function(a) {
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseCapture: function(b, c) {
            ...
            return (a.data(b.target, d.widgetName + "-item") == f && (e = a(b.target)),
            !e) ? !1 : this.options.handle && !c && (h = !1,
            a(this.options.handle, e).find("*").andSelf().each(function() {
                this == b.target && (h = !0)
            }),
            !h) ? !1 : (this.currentItem = e,
        ...
        _mouseDrag: function(b) {
            ...
            this.options.scroll && (c = this.options,
            d = !1,
            ...
            e = this.items.length - 1; e >= 0; e--) {
                ...
                if (h && g != this.currentItem[0] && this.placeholder[h == 1 ? "next" : "prev"]()[0] != g && !a.ui.contains(this.placeholder[0], g) && (this.options.type == "semi-dynamic" ? !a.ui.contains(this.element[0], g) : !0)) {
                    if (this.direction = h == 1 ? "down" : "up",
        ...
        _getItemsAsjQuery: function(b) {
            var c = this, d = [], e = [], f = this._connectWith(), h, i, j, g;
            if (f && b)
                for (g = f.length - 1; g >= 0; g--)
                    for (h = a(f[g]),
                    i = h.length - 1; i >= 0; i--)
                        j = a.data(h[i], this.widgetName),
                        j && j != this && !j.options.disabled && e.push([a.isFunction(j.options.items) ? j.options.items.call(j.element) : a(j.options.items, j.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), j]);
            for (e.push([a.isFunction(this.options.items) ? this.options.items.call(this.element, null , {
        ...
        _removeCurrentsFromItems: function() {
            for (var c, a = this.currentItem.find(":data(" + this.widgetName + "-item)"), b = 0; b < this.items.length; b++)
        ...
        _createPlaceholder: function(b) {
            ...
            d.placeholder = {
                ...
                update: function(a, b) {
                    e && !d.forcePlaceholderSize || (b.height() || b.height(c.currentItem.innerHeight() - parseInt(c.currentItem.css("paddingTop") || 0, 10) - parseInt(c.currentItem.css("paddingBottom") || 0, 10)),
        ...
        _contactContainers: function(b) {
            for (var i, j, c = null , d = null , e = this.containers.length - 1; e >= 0; e--)
            ...
            if (!!c)
                if (this.containers.length === 1)
                    ...
                    for (i = this.items.length - 1; i >= 0; i--)
                        a.ui.contains(this.containers[d].element[0], this.items[i].item[0]) && (j = this.items[i][this.containers[d].floating ? "left" : "top"],
        ...
        _generatePosition: function(b) {
            var c = this.options, d = this.cssPosition == "absolute" && (this.scrollParent[0] == document || !a.ui.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent, e = /(html|body)/i.test(d[0].tagName), f, g, h, i;
            ...
            c.grid && (h = this.originalPageY + Math.round((g - this.originalPageY) / c.grid[1]) * c.grid[1],
            g = this.containment ? h - this.offset.click.top < this.containment[1] || h - this.offset.click.top > this.containment[3] ? h - this.offset.click.top < this.containment[1] ? h + c.grid[1] : h - c.grid[1] : h : h,
            i = this.originalPageX + Math.round((f - this.originalPageX) / c.grid[0]) * c.grid[0],
        ...
        _clear: function(b, c) {
            ...
            this.helper[0] == this.currentItem[0]) {
                for (f in this._storedCSS)
                    (this._storedCSS[f] == "auto" || this._storedCSS[f] == "static") && (this._storedCSS[f] = "");
            ...
            !a.ui.contains(this.element[0], this.currentItem[0]))
                ...
                f = this.containers.length - 1; f >= 0; f--)
            ...
            this.cancelHelperRemoval) {
                if (!c) {
                    for (this._trigger("beforeStop", b, this._uiHash()),
                    f = 0; f < d.length; f++)
                        d[f].call(this, b);
...
function(a) {
    a.widget("ui.accordion", {
        ...
        _create: function() {
            ...
            c.navigation && (d = b.element.find("a").filter(c.navigationFilter).eq(0),
            d.length && (e = d.closest(".ui-accordion-header"),
        ...
        destroy: function() {
            ...
            this._destroyIcons(),
            c = this.headers.next().css("display", "").removeAttr("role").removeClass("ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content ui-accordion-content-active ui-accordion-disabled ui-state-disabled"),
        ...
        resize: function() {
            ...
            return b.fillSpace ? (a.browser.msie && (d = this.element.parent().css("overflow"),
            ...
            }).css("overflow", "auto")) : b.autoHeight && (c = 0,
            this.headers.next().each(function() {
        ...
        _clickHandler: function(b, c) {
            ...
            if (!d.disabled) {
                ...
                if (h = a(b.currentTarget || c),
                i = h[0] === this.active[0],
                d.active = d.collapsible && i ? !1 : this.headers.index(h),
                this.running || !d.collapsible && i)
                    return;
                var j = this.active
                  , g = h.next()
                  , e = this.active.next()
        ...
        animations: {
            slide: function(b, c) {
                ...
                b.toHide.size()) {
                    ...
                    var d = b.toShow.css("overflow"), e = 0, f = {}, g = {}, i, j = b.toShow;
                    i = j[0].style.width;
...
function(a) {
    ...
    a.widget("ui.autocomplete", {
        ...
        search: function(a, b) {
            return (a = a != null  ? a : this.element.val(),
            this.term = this.element.val(),
            a.length < this.options.minLength) ? this.close(b) : (clearTimeout(this.closing),
            this._trigger("search", b) !== !1 ? this._search(a) : void 0)
        },
        _search: function(a) {
            this.pending++;
...
function(a) {
    ...
    a.widget("ui.button", {
        ...
        _determineButtonType: function() {
            ...
            this.type === "checkbox" || this.type === "radio" ? (a = this.element.parents().filter(":last"),
            ...
            this.buttonElement.attr("aria-pressed", c)) : this.buttonElement = this.element
        },
        widget: function() {
...
function(a, b) {
    ...
    a.widget("ui.dialog", {
        ...
        _position: function(b) {
            var c = [], d = [0, 0], e;
            b ? ((typeof b == "string" || typeof b == "object" && "0" in b) && (c = b.split ? b.split(" ") : [b[0], b[1]],
            c.length === 1 && (c[1] = c[0]),
        ...
        _size: function() {
            var b = this.options, c, d, e = this.uiDialog.is(":visible"), f;
            ...
            b.height === "auto" ? a.support.minHeight ? this.element.css({
                minHeight: d,
                height: "auto"
            }) : (this.uiDialog.show(),
            f = this.element.css("height", "auto").height(),
            e || this.uiDialog.hide(),
            this.element.height(Math.max(f, d))) : this.element.height(Math.max(b.height - c, 0));
    ...
    a.extend(a.ui.dialog.overlay, {
        ...
        destroy: function(b) {
            var c = a.inArray(b, this.instances), d;
...
function(a) {
    ...
    a.widget("ui.slider", a.ui.mouse, {
        ...
        _create: function() {
            var b = this, d = this.options, e = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"), g = d.values && d.values.length || 1, h = [], i;
            ...
            i = e.length; i < g; i += 1)
                h.push("<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'><\/a>");
            ...
            this.handles.keydown(function(d) {
                ...
                if (!b.options.disabled) {
                    ...
                    i = b.options.step;
                    g = b.options.values && b.options.values.length ? h = b.values(e) : h = b.value();
                    switch (d.keyCode) {
                    case a.ui.keyCode.HOME:
                        h = b._valueMin();
                        break;
...
function(a, b) {
    ...
    a.widget("ui.tabs", {
        ...
        _tabify: function(c) {
            ...
            var e = this, f = this.options, g = /^#.+/, h, i, j, k, l, m, n, o;
            ...
            this.anchors.each(function(b, c) {
                var d = a(c).attr("href"), h = d.split("#")[0], i, j, k;
                h && (h === location.toString().split("#")[0] || (i = a("base")[0]) && h === i.href) && (d = c.hash,
                c.href = d);
                g.test(d) ? e.panels = e.panels.add(e.element.find(e._sanitizeSelector(d))) : d && d !== "#" ? (a.data(c, "href.tabs", d),
                a.data(c, "load.tabs", d.replace(/#.*$/, "")),
                j = e._tabId(c),
                c.href = "#" + j,
                k = e.element.find("#" + j),
                k.length || (k = a(f.panelTemplate).attr("id", j).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(e.panels[b - 1] || e.list),
                k.data("destroy.tabs", !0)),
                e.panels = e.panels.add(k)) : f.disabled.push(b)
            }),
            c ? (this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"),
            this.list.addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all"),
            this.lis.addClass("ui-state-default ui-corner-top"),
            this.panels.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom"),
            f.selected === b ? (location.hash && this.anchors.each(function(a, b) {
                if (b.hash == location.hash)
                    return f.selected = a,
                    !1
            }),
            typeof f.selected != "number" && f.cookie && (f.selected = parseInt(e._cookie(), 10)),
            typeof f.selected != "number" && this.lis.filter(".ui-tabs-selected").length && (f.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"))),
            f.selected = f.selected || (this.lis.length ? 0 : -1)) : f.selected === null  && (f.selected = -1),
            ...
            f.selected >= 0 && this.anchors.length && (e.element.find(e._sanitizeSelector(e.anchors[f.selected].hash)).removeClass("ui-tabs-hide"),
            ...
            h = 0; i = this.lis[h]; h++)
                a(i)[a.inArray(h, f.disabled) != -1 && !a(i).hasClass("ui-tabs-selected") ? "addClass" : "removeClass"]("ui-state-disabled");
            f.cache === !1 && this.anchors.removeData("cache.tabs");
            this.lis.add(this.anchors).unbind(".tabs");
            f.event !== "mouseover" && (j = function(a, b) {
            ...
            f.fx && (a.isArray(f.fx) ? (l = f.fx[0],
            m = f.fx[1]) : l = m = f.fx);
            n = m ? function(b, c) {
                a(b).closest("li").addClass("ui-tabs-selected ui-state-active");
                c.hide().removeClass("ui-tabs-hide").animate(m, m.duration || "normal", function() {
                    d(c, m);
            ...
            this.anchors.bind(f.event + ".tabs", function() {
                ...
                if (c.hasClass("ui-tabs-selected") && !f.collapsible || c.hasClass("ui-state-disabled") || c.hasClass("ui-state-processing") || e.panels.filter(":animated").length || e._trigger("select", null , e._ui(this, g[0])) === !1)
                    return this.blur(),
                    !1;
                if (f.selected = e.anchors.index(this),
                e.abort(),
                f.collapsible) {
                    if (c.hasClass("ui-tabs-selected"))
                        ...
                        !1;
                    if (!d.length)
                        return f.cookie && e._cookie(f.selected, f.cookie),
                        e.element.queue("tabs", function() {
                            n(b, g)
                        }),
                ...
                if (f.cookie && e._cookie(f.selected, f.cookie),
                g.length)
        ...
        destroy: function() {
            ...
            this.anchors.each(function() {
                var b = a.data(this, "href.tabs"), c;
                b && (this.href = b);
                c = a(this).unbind(".tabs");
        ...
        add: function(c, d, e) {
            ...
            return h.addClass("ui-state-default ui-corner-top").data("destroy.tabs", !0),
            j = f.element.find("#" + i),
        ...
        load: function(b) {
            ...
            if (this.abort(),
            !f || this.element.queue("tabs").length !== 0 && a.data(e, "cache.tabs"))
                this.element.dequeue("tabs");
            else
                return this.lis.eq(b).addClass("ui-state-processing"),
                d.spinner && (g = a("span", e),
...
function($, undefined) {
    ...
    function extendRemove(a, b) {
        $.extend(a, b);
        for (var c in b)
            (b[c] == null  || b[c] == undefined) && (a[c] = b[c]);
        return a
    }
    $.extend($.ui, {
        datepicker: {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachments: function(a, b) {
            var c = this._get(b, "appendText"), d = this._get(b, "isRTL"), e, f, g;
            b.append && b.append.remove();
            c && (b.append = $('<span class="' + this._appendClass + '">' + c + "<\/span>"),
            a[d ? "before" : "after"](b.append));
            a.unbind("focus", this._showDatepicker);
            b.trigger && b.trigger.remove();
            e = this._get(b, "showOn");
            (e == "focus" || e == "both") && a.focus(this._showDatepicker);
            (e == "button" || e == "both") && (f = this._get(b, "buttonText"),
        ...
        _autoSize: function(a) {
            var b, c, d;
            this._get(a, "autoSize") && !a.inline && (b = new Date(2009,11,20),
        ...
        _destroyDatepicker: function(a) {
            var b = $(a), c = $.data(a, PROP_NAME), d;
            !b.hasClass(this.markerClassName) || (d = a.nodeName.toLowerCase(),
        ...
        _enableDatepicker: function(a) {
            var b = $(a), c = $.data(a, PROP_NAME), d, e;
            !b.hasClass(this.markerClassName) || (d = a.nodeName.toLowerCase(),
            d == "input" ? (a.disabled = !1,
            c.trigger.filter("button").each(function() {
                this.disabled = !1
            }).end().filter("img").css({
                opacity: "1.0",
                cursor: ""
            })) : (d == "div" || d == "span") && (e = b.children("." + this._inlineClass),
        ...
        _doKeyDown: function(a) {
            var b = $.datepicker._getInst(a.target), c = !0, d = b.dpDiv.is(".ui-datepicker-rtl"), e, f, g;
            if (b._keyEvent = !0,
            $.datepicker._datepickerShowing)
                ...
                case 9:
                    ...
                    break;
                case 13:
                    return e = $("td." + $.datepicker._dayOverClass + ":not(." + $.datepicker._currentClass + ")", b.dpDiv),
                    e[0] && $.datepicker._selectDay(a.target, b.selectedMonth, b.selectedYear, e[0]),
                    f = $.datepicker._get(b, "onSelect"),
                    f ? (g = $.datepicker._formatDate(b),
                    f.apply(b.input ? b.input[0] : null , [g, b])) : $.datepicker._hideDatepicker(),
                    !1;
                case 27:
                    $.datepicker._hideDatepicker();
                    break;
        ...
        _doKeyPress: function(a) {
            var b = $.datepicker._getInst(a.target), c, d;
            if ($.datepicker._get(b, "constrainInput"))
                return c = $.datepicker._possibleChars($.datepicker._get(b, "dateFormat")),
                d = String.fromCharCode(a.charCode == undefined ? a.keyCode : a.charCode),
                a.ctrlKey || a.metaKey || d < " " || !c || c.indexOf(d) > -1
        },
        _doKeyUp: function(a) {
            var b = $.datepicker._getInst(a.target), c;
            if (b.input.val() != b.lastVal)
                try {
                    c = $.datepicker.parseDate($.datepicker._get(b, "dateFormat"), b.input ? b.input.val() : null , $.datepicker._getFormatConfig(b));
        ...
        _showDatepicker: function(a) {
            ...
            !$.datepicker._isDisabledDatepicker(a) && $.datepicker._lastInput != a) {
                ...
                c = $.datepicker._get(b, "beforeShow"),
                d = c ? c.apply(a, [a, b]) : {},
                d === !1)
                    return;
                if (extendRemove(b.settings, d),
                b.lastVal = null ,
                ...
                !b.inline) {
                    var g = $.datepicker._get(b, "showAnim")
                      ...
                      , i = function() {
                        var a = b.dpDiv.find("iframe.ui-datepicker-cover"), c;
                        !a.length || (c = $.datepicker._getBorders(b.dpDiv),
                        a.css({
                            left: -c[0],
                            top: -c[1],
        ...
        _updateDatepicker: function(a) {
            ...
            d = a.dpDiv.find("iframe.ui-datepicker-cover");
            d.length && d.css({
                left: -c[0],
                top: -c[1],
            ...
            f > 1 && a.dpDiv.addClass("ui-datepicker-multi-" + f).css("width", 17 * f + "em");
        ...
        _findPos: function(a) {
            for (var b = this._getInst(a), c = this._get(b, "isRTL"), d; a && (a.type == "hidden" || a.nodeType != 1 || $.expr.filters.hidden(a)); )
                a = a[c ? "previousSibling" : "nextSibling"];
            return d = $(a).offset(),
            [d.left, d.top]
        },
        _hideDatepicker: function(a) {
            var b = this._curInst, g;
        ...
        _gotoToday: function(a) {
            var b = $(a), c = this._getInst(b[0]), d;
            this._get(c, "gotoCurrent") && c.currentDay ? (c.selectedDay = c.currentDay,
            c.drawMonth = c.selectedMonth = c.currentMonth,
            c.drawYear = c.selectedYear = c.currentYear) : (d = new Date,
        ...
        _selectDay: function(a, b, c, d) {
            var e = $(a), f;
            $(d).hasClass(this._unselectableClass) || this._isDisabledDatepicker(e[0]) || (f = this._getInst(e[0]),
        ...
        parseDate: function(a, b, c) {
            ...
            if (b = typeof b == "object" ? b.toString() : b + "",
            b == "")
                return null ;
            d = (c ? c.shortYearCutoff : null ) || this._defaults.shortYearCutoff;
            ...
            l > -1)
                for (j = 1,
                k = l; ; ) {
                    if (u = this._getDaysInMonth(i, j - 1),
                    k <= u)
                        break;
                    j++;
                    k -= u
                }
            if (t = this._daylightSavingAdjust(new Date(i,j - 1,k)),
            t.getFullYear() != i || t.getMonth() + 1 != j || t.getDate() != k)
                throw "Invalid date";
            return t
        },
        ATOM: "yy-mm-dd",
        ...
        _generateHTML: function(a) {
            var b = new Date, p, q, r, s, L, M, N, R, T, U, Y, Z, _, S;
            ...
            o--),
            m)
                for (p = this._daylightSavingAdjust(new Date(m.getFullYear(),m.getMonth() - g[0] * g[1] + 1,m.getDate())),
                p = l && p < l ? l : p; this._daylightSavingAdjust(new Date(o,n,1)) > p; )
                    n--,
                    n < 0 && (n = 11,
                    o--);
            a.drawMonth = n;
            a.drawYear = o;
            q = this._get(a, "prevText");
            q = f ? this.formatDate(q, this._daylightSavingAdjust(new Date(o,n - i,1)), this._getFormatConfig(a)) : q;
            r = this._canAdjustMonth(a, -1, o, n) ? '<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_' + dpuuid + ".datepicker._adjustDate('#" + a.id + "', -" + i + ", 'M');\" title=\"" + q + '"><span class="ui-icon ui-icon-circle-triangle-' + (c ? "e" : "w") + '">' + q + "<\/span><\/a>" : e ? "" : '<a class="ui-datepicker-prev ui-corner-all ui-state-disabled" title="' + q + '"><span class="ui-icon ui-icon-circle-triangle-' + (c ? "e" : "w") + '">' + q + "<\/span><\/a>";
            ...
            for (L = 0; L < g[0]; L++) {
                ...
                N = 0; N < g[1]; N++) {
                    ...
                    for (Q += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + P + '">' + (/all|left/.test(P) && L == 0 ? c ? t : r : "") + (/all|right/.test(P) && L == 0 ? c ? r : t : "") + this._generateMonthYearHeader(a, n, o, l, m, L > 0 || N > 0, D, E) + '<\/div><table class="ui-datepicker-calendar"><thead><tr>',
                    R = z ? '<th class="ui-datepicker-week-col">' + this._get(a, "weekHeader") + "<\/th>" : "",
                    S = 0; S < 7; S++)
                        T = (S + y) % 7,
                        R += "<th" + ((S + y + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : "") + '><span title="' + A[T] + '">' + C[T] + "<\/span><\/th>";
                    Q += R + "<\/tr><\/thead><tbody>";
                    U = this._getDaysInMonth(o, n);
                    o == a.selectedYear && n == a.selectedMonth && (a.selectedDay = Math.min(a.selectedDay, U));
                    var V = (this._getFirstDayOfMonth(o, n) - y + 7) % 7
                      , W = Math.ceil((V + U) / 7)
                      , X = j ? this.maxRows > W ? this.maxRows : W : W;
                    for (this.maxRows = X,
                    Y = this._daylightSavingAdjust(new Date(o,n,1 - V)),
                    Z = 0; Z < X; Z++) {
                        for (Q += "<tr>",
                        _ = z ? '<td class="ui-datepicker-week-col">' + this._get(a, "calculateWeek")(Y) + "<\/td>" : "",
                        S = 0; S < 7; S++) {
        ...
        _generateMonthYearHeader: function(a, b, c, d, e, f, g, h) {
            var i = this._get(a, "changeMonth"), j = this._get(a, "changeYear"), k = this._get(a, "showMonthAfterYear"), l = '<div class="ui-datepicker-title">', m = "", n, o, p;
            if (f || !i)
                m += '<span class="ui-datepicker-month">' + g[b] + "<\/span>";
            else {
                for (n = d && d.getFullYear() == c,
                o = e && e.getFullYear() == c,
            ...
            !a.yearshtml)
                ...
                f || !j)
                    ...
                    a.yearshtml += '<select class="ui-datepicker-year" onchange="DP_jQuery_' + dpuuid + ".datepicker._selectMonthYear('#" + a.id + "', this, 'Y');\" >"; t <= u; t++)
    ...
    $.fn.datepicker = function(a) {
        ...
        return typeof a == "string" && (a == "isDisabled" || a == "getDate" || a == "widget") ? $.datepicker["_" + a + "Datepicker"].apply($.datepicker, [this[0]].concat(b)) : a == "option" && arguments.length == 2 && typeof arguments[1] == "string" ? $.datepicker["_" + a + "Datepicker"].apply($.datepicker, [this[0]].concat(b)) : this.each(function() {
...
jQuery.effects || function(a, b) {
    ...
    function h(b, c) {
        ...
        do {
            if (d = a.curCSS(b, c),
            d != "" && d != "transparent" || a.nodeName(b, "body"))
                break;
            c = "backgroundColor"
        } while (b = b.parentNode);return i(d)
    }
    function g() {
        var a = document.defaultView ? document.defaultView.getComputedStyle(this, null ) : this.currentStyle, b = {}, c, d, e;
    ...
    function f(b) {
        ...
        for (c in b)
            d = b[c],
            (d == null  || a.isFunction(d) || c in l || /scrollbar/.test(c) || !/color/i.test(c) && isNaN(parseFloat(d))) && delete b[c];
        return b
    }
    function e(a, b) {
        var c = {
    ...
    function d(b, c, d, e) {
        ...
        d = null ,
        c = {}),
        (typeof c == "number" || a.fx.speeds[c]) && (e = d,
        d = c,
        c = {}),
        a.isFunction(d) && (e = d,
        d = null ),
    ...
    a.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "borderColor", "color", "outlineColor"], function(b, c) {
        a.fx.step[c] = function(a) {
            a.colorInit || (a.start = h(a.elem, c),
            a.end = i(a.end),
            a.colorInit = !0);
    ...
    a.effects.animateClass = function(b, c, d, h) {
        ...
        d = null ),
        this.queue(function() {
            var i = a(this), j = i.attr("style") || " ", l = f(g.call(this)), m, n = i.attr("class");
            ...
            i.animate(e(l, m), {
                ...
                complete: function() {
                    ...
                    typeof i.attr("style") == "object" ? (i.attr("style").cssText = "",
    ...
    a.fn.extend({
        effect: function(b) {
            var g = d.apply(this, arguments)
              ...
              , i = h.options.mode
              , j = a.effects[b];
            return a.fx.off || !j ? i ? this[i](h.duration, h.callback) : this.each(function() {
        ...
        toggle: function(b) {
            if (c(b) || typeof b == "boolean" || a.isFunction(b))
    ...
    a.extend(a.easing, {
        ...
        easeInElastic: function(a, b, c, d, e) {
            var f = 1.70158
              , g = 0
              , h = d;
            return b == 0 ? c : (b /= e) == 1 ? c + d : (g || (g = e * .3),
            h < Math.abs(d) ? (h = d,
        ...
        easeInOutElastic: function(a, b, c, d, e) {
            var f = 1.70158
              , g = 0
              , h = d;
            return b == 0 ? c : (b /= e / 2) == 2 ? c + d : (g || (g = e * .3 * 1.5),
            h < Math.abs(d) ? (h = d,
            f = g / 4) : f = g / (2 * Math.PI) * Math.asin(d / h),
            b < 1) ? -.5 * h * Math.pow(2, 10 * (b -= 1)) * Math.sin((b * e - f) * 2 * Math.PI / g) + c : h * Math.pow(2, -10 * (b -= 1)) * Math.sin((b * e - f) * 2 * Math.PI / g) * .5 + d + c
        },
...
function(a) {
    a.effects.blind = function(b) {
        return this.queue(function() {
            var c = a(this), d = ["position", "top", "bottom", "left", "right"], e = a.effects.setMode(c, b.options.mode || "hide"), f = b.options.direction || "vertical", j;
            a.effects.save(c, d);
            c.show();
...
function(a) {
    a.effects.bounce = function(b) {
        return this.queue(function() {
            var c = a(this), d = ["position", "top", "bottom", "left", "right"], e = a.effects.setMode(c, b.options.mode || "effect"), f = b.options.direction || "up", g = b.options.distance || 20, h = b.options.times || 5, i = b.duration || 250, m, l, n, o;
            ...
            for (e == "show" && c.css("opacity", 0).css(j, k == "pos" ? -g : g),
            e == "hide" && (g = g / (h * 2)),
            e != "hide" && h--,
            e == "show" && (l = {
                opacity: 1
            ...
            m = 0; m < h; m++)
                ...
                n[j] = (k == "pos" ? "-=" : "+=") + g,
                o[j] = (k == "pos" ? "+=" : "-=") + g,
                c.animate(n, i / 2, b.options.easing).animate(o, i / 2, b.options.easing),
                g = e == "hide" ? g * 2 : g / 2;
            e == "hide" ? (l = {
                opacity: 0
            },
            ...
            n[j] = (k == "pos" ? "-=" : "+=") + g,
            o[j] = (k == "pos" ? "+=" : "-=") + g,
            c.animate(n, i / 2, b.options.easing).animate(o, i / 2, b.options.easing, function() {
                a.effects.restore(c, d);
                a.effects.removeWrapper(c);
                b.callback && b.callback.apply(this, arguments)
            }));
...
function(a) {
    a.effects.clip = function(b) {
        return this.queue(function() {
            var c = a(this), d = ["position", "top", "bottom", "left", "right", "height", "width"], e = a.effects.setMode(c, b.options.mode || "hide"), f = b.options.direction || "vertical", k;
            a.effects.save(c, d);
            c.show();
            var g = a.effects.createWrapper(c).css({
                overflow: "hidden"
...
function(a) {
    a.effects.drop = function(b) {
        return this.queue(function() {
            var c = a(this), d = ["position", "top", "bottom", "left", "right", "opacity"], e = a.effects.setMode(c, b.options.mode || "hide"), f = b.options.direction || "left", j;
            a.effects.save(c, d);
            c.show();
            a.effects.createWrapper(c);
...
function(a) {
    a.effects.explode = function(b) {
        return this.queue(function() {
            var c = b.options.pieces ? Math.round(Math.sqrt(b.options.pieces)) : 3, d = b.options.pieces ? Math.round(Math.sqrt(b.options.pieces)) : 3, e, f, g, h, i, j;
            for (b.options.mode = b.options.mode == "toggle" ? a(this).is(":visible") ? "hide" : "show" : b.options.mode,
            e = a(this).show().css("visibility", "hidden"),
            f = e.offset(),
...
function(a) {
    a.effects.fold = function(b) {
        return this.queue(function() {
            var c = a(this), d = ["position", "top", "bottom", "left", "right"], e = a.effects.setMode(c, b.options.mode || "hide"), f = b.options.size || 15, g = !!b.options.horizFirst, h = b.duration ? b.duration / 2 : a.fx.speeds._default / 2, n, o;
            a.effects.save(c, d);
            c.show();
            ...
            n[k[0]] = e == "show" ? l[0] : f;
            o[k[1]] = e == "show" ? l[1] : 0;
            i.animate(n, h, b.options.easing).animate(o, h, b.options.easing, function() {
                e == "hide" && c.hide();
                a.effects.restore(c, d);
                a.effects.removeWrapper(c);
                b.callback && b.callback.apply(c[0], arguments);
...
function(a) {
    a.effects.pulsate = function(b) {
        return this.queue(function() {
            var c = a(this), d = a.effects.setMode(c, b.options.mode || "show"), e;
            for (times = (b.options.times || 5) * 2 - 1,
...
function(a) {
    ...
    a.effects.scale = function(b) {
        return this.queue(function() {
            var c = a(this), d = a.extend(!0, {}, b.options), e = a.effects.setMode(c, b.options.mode || "effect"), f = parseInt(b.options.percent, 10) || (parseInt(b.options.percent, 10) == 0 ? 0 : e == "hide" ? 0 : 100), g = b.options.direction || "both", h = b.options.origin, i, j;
    ...
    a.effects.size = function(b) {
        return this.queue(function() {
            ...
            c.to = b.options.to || n;
            m && (o = a.effects.getBaseline(m, n),
            c.from.top = (n.height - c.from.height) * o.y,
            c.from.left = (n.width - c.from.width) * o.x,
            c.to.top = (n.height - c.to.height) * o.y,
            c.to.left = (n.width - c.to.width) * o.x);
            p = {
                from: {
            ...
            (l == "box" || l == "both") && (p.from.y != p.to.y && (d = d.concat(h),
            c.from = a.effects.setTransition(c, h, p.from.y, c.from),
            c.to = a.effects.setTransition(c, h, p.to.y, c.to)),
            p.from.x != p.to.x && (d = d.concat(i),
            c.from = a.effects.setTransition(c, i, p.from.x, c.from),
            c.to = a.effects.setTransition(c, i, p.to.x, c.to)));
            (l == "content" || l == "both") && p.from.y != p.to.y && (d = d.concat(g),
            c.from = a.effects.setTransition(c, g, p.from.y, c.from),
            c.to = a.effects.setTransition(c, g, p.to.y, c.to));
            a.effects.save(c, k ? d : e);
            c.show();
            a.effects.createWrapper(c);
            c.css("overflow", "hidden").css(c.from);
            (l == "content" || l == "both") && (h = h.concat(["marginTop", "marginBottom"]).concat(g),
            ...
            c.find("*[width]").each(function() {
                ...
                p.from.y != p.to.y && (child.from = a.effects.setTransition(child, h, p.from.y, child.from),
                child.to = a.effects.setTransition(child, h, p.to.y, child.to));
                p.from.x != p.to.x && (child.from = a.effects.setTransition(child, i, p.from.x, child.from),
                child.to = a.effects.setTransition(child, i, p.to.x, child.to));
...
function(a) {
    a.effects.shake = function(b) {
        return this.queue(function() {
            var c = a(this), d = ["position", "top", "bottom", "left", "right"], e = a.effects.setMode(c, b.options.mode || "effect"), f = b.options.direction || "left", g = b.options.distance || 20, h = b.options.times || 3, i = b.duration || b.options.duration || 140, o;
            a.effects.save(c, d);
            c.show();
            a.effects.createWrapper(c);
            var j = f == "up" || f == "down" ? "top" : "left"
...
function(a) {
    a.effects.slide = function(b) {
        return this.queue(function() {
            var c = a(this), d = ["position", "top", "bottom", "left", "right"], e = a.effects.setMode(c, b.options.mode || "show"), f = b.options.direction || "left", j;
            a.effects.save(c, d);
            c.show();
