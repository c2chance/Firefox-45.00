...
!function(a, b) {
        ...
        if (m.acceptData(a)) {
            ...
            if (g[h]) {
                if (b && (d = c ? g[h] : g[h].data)) {
                    for (m.isArray(b) ? b = b.concat(m.map(b, m.camelCase)) : (b in d) ? b = [
                    b
                    ] : (b = m.camelCase(b),
                    b = (b in d) ? [
                    b
    ...
    m.extend({
        dir: function(a, b, c) {
            for (var d = [
            ], e = a[b]; e && 9 !== e.nodeType && (void 0 === c || 1 !== e.nodeType || !m(e).is(c)); )
    ...
    !function() {
        ...
        c = d && d.style) {
            ...
            function i() {
                ...
                e = f = !1,
                h = !0,
                a.getComputedStyle && (e = '1%' !== (a.getComputedStyle(b, null ) || {
                }).top,
                ...
                b.style.width = '1px',
                h = !parseFloat((a.getComputedStyle(i, null ) || {
                }).marginRight)),
