function initValidationStrings() {
    monthNamesAll = [$trees.res.getString("g.monthNamesJan"), 
      $trees.res.getString("g.monthNamesFeb"), 
      $trees.res.getString("g.monthNamesMar"), 
      $trees.res.getString("g.monthNamesApr"), 
      $trees.res.getString("g.monthNamesMay"), 
      $trees.res.getString("g.monthNamesJun"), 
      $trees.res.getString("g.monthNamesJul"), 
      $trees.res.getString("g.monthNamesAug"), 
      $trees.res.getString("g.monthNamesSep"), 
      $trees.res.getString("g.monthNamesOct"), 
      $trees.res.getString("g.monthNamesNov"), 
      $trees.res.getString("g.monthNamesDec")];
      
    monthAbbrs = [$trees.res.getString("g.monthAbbrsJan"), 
      $trees.res.getString("g.monthAbbrsFeb"), 
      $trees.res.getString("g.monthAbbrsMar"), 
      $trees.res.getString("g.monthAbbrsApr"), 
      $trees.res.getString("g.monthAbbrsMay"), 
      $trees.res.getString("g.monthAbbrsJun"), 
      $trees.res.getString("g.monthAbbrsJul"), 
      $trees.res.getString("g.monthAbbrsAug"), 
      $trees.res.getString("g.monthAbbrsSep"), 
      $trees.res.getString("g.monthAbbrsOct"), 
      $trees.res.getString("g.monthAbbrsNov"), 
      $trees.res.getString("g.monthAbbrsDec")];
...
var monthNamesAll, monthAbbrs, aboutAbbr, beforeAbbr, afterAbbr, 
  betweenAbbr, conjunctionAbbr, rangeAbbr, unknown, monthDayYearOrder, 
  warnDateYearTooBig, warnDateTwoMonths, warnDateDayWithoutMonth, 
  warnDateTwoDays, warnDateTwoYears, warnDateDayTooLarge, warnDateMonthTooLarge, 
  warnDateInvalidMonth, warnDateBirthBeforeMother, warnDateBirthAfterMother, 
  warnDateBirthBeforeFather, warnDateBirthAfterFather, warnDateBirth120BeforeDeath, 
  warnDateDeath120AfterBirth, warnDateBeforeBirth, warnDateAfterDeath, 
  warnDateMayBeWrong, warnStillUseIt, warnOfTheSpouse, badBirthDate, 
  badDeathDate, badMarriageDate, warnLastName, warnNameFather, 
  warnNameMaiden, invalidNameChars, errorNameInvalidChar, 
  $val = {}
