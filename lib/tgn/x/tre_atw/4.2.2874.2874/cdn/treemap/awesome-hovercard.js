...
$(function() {
    ...
    $("#trGraph").on("pointertouchmousedown", ".node-bdy", function(e) {
        ...
        checkMove = setInterval(function() {
            ...
            ($("body").hasClass("treeViewerAwesomeHoverCardActive") || $("html").hasClass("modalOpen")) && 
              ($("body").removeClass("moveGraphOrTriggerClick"), clearInterval(checkMove))
        }, 10)
        ...
        !$("body").hasClass("treeViewerAwesomeHoverCardActive") && 
          $this.data("data-mouseupoffset") > $(this).data("data-mousedownoffset") - 25 && 
          $this.data("data-mouseupoffset") < $(this).data("data-mousedownoffset") + 25 && (showHoverCard = showAddPerson = !0);
        $this.parent(".node").hasClass("add") ? showAddPerson === !1 ? ($this.data("data-onclick", $this.attr("onclick")),
          ...
          $trees.hovercard.handleNodeMouseOver(this.parentNode), showHoverCard = !1)
    })
})
